...
### Время рендеринга кадра в тиках процессора $\cdot 10^6$
...
### Время расчета множества Мандельброта в FPS
...
### Время расчета множества Мандельброта в тиках процессора * 10^6
...
Исходя из полученных результатов, мы можем заметить, что время рендеринга кадра не сильно отличается от времени расчета множества Мандельброта. Таким образом, главную роль в быстродействии кода играет расчет кадра.
