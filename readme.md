...
$z_{n+1} = z_{n} ^ 2 + c$, при $z_{0} = 0$ задаёт ограниченную последовательность. Иными словами, это множество таких $c$, для которых существует такое действительное $R$, что неравенство $|z_{n}|<R$ выполняется при всех натуральных n.
