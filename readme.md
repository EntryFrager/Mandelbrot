...
Ниже приведена таблица с величинами, которые характеризуют увеличение быстродействия кода. Наивный метод рендеринга, с уровнем оптимизации -O2 будем считать за `1`, а все остальные величины будем расчитывать относительно нее.
